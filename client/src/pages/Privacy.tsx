...
const privacySections = [
  ...
  },
  {
    ...
    body: [
      ...
      "회원 탈퇴는 삭제 예약 방식으로 처리됩니다. 탈퇴 신청 시 즉시 서비스 이용이 중단되며, 30일의 유예 기간이 지난 뒤 계정과 저장된 데이터가 파기됩니다. 유예 기간 중에는 다시 로그인하여 탈퇴를 취소할 수 있습니다.",
      "다만 다음의 경우에는 일정 기간 보관할 수 있습니다.",
    ],
    table: {
      headers: ["보관 대상", "보관 기간"],
      rows: [
        ["회원 정보", "회원 탈퇴(삭제 예약) 후 30일까지"],
        ["업로드한 자기소개서", "회원이 삭제한 때 또는 회원 탈퇴(삭제 예약) 후 30일까지"],
        ["서비스 이용 기록", "최대 1년"],
  ...
  },
  {
    ...
    footer:
      "회원 탈퇴 신청 시 30일의 유예 기간이 지난 뒤 관련 개인정보가 삭제되며, 관계 법령에 따른 보관 의무가 있는 정보는 예외로 합니다. 유예 기간 중에는 다시 로그인하여 탈퇴를 취소할 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "2026년 8월 29일 개정: 회원 탈퇴 시 30일 유예 기간 후 파기되는 절차를 명시했습니다.",
    ],
  },
];
