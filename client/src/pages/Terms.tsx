...
const terms = [
  {
    title: "제1조 (목적)",
    body: [
      '본 약관은 Pre:View(이하 "회사")가 제공하는 AI 자기소개서 분석 서비스(이하 "서비스")의 이용과 관련하여 회사와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.',
    ],
  },
  {
    title: "제2조 (정의)",
  ...
  },
  {
    ...
    body: [
      ...
      "일부 서비스는 유료로 제공될 수 있으며, 가격 및 이용조건은 결제 화면에서 별도로 안내합니다.",
      "유료 서비스 이용 시 별도의 결제 정책이 적용됩니다.",
    ],
  },
  {
    title: "제6조의2 (환불 및 청약철회)",
    body: [
      "이용자는 유료 이용권 결제일로부터 7일 이내에, 결제한 분석 횟수를 전혀 사용하지 않은 경우에 한하여 전액 환불을 요청할 수 있습니다.",
      "결제한 분석 횟수를 1회 이상 사용한 경우 또는 결제일로부터 7일이 지난 경우에는 환불이 불가능합니다.",
      "AI 분석 리포트는 제공 즉시 효용이 발생하는 디지털 콘텐츠로, 제공이 시작된 이용권에 대해서는 「전자상거래 등에서의 소비자보호에 관한 법률」 제17조 제2항에 따라 청약철회가 제한됩니다. 회사는 결제 전 이 사실을 고지합니다.",
      "분석이 정상적으로 완료되지 않은 경우(오류·실패 등) 해당 분석 횟수는 차감되지 않으며, 차감된 경우 복구 또는 환불해 드립니다.",
      "분석 리포트는 AI가 생성하는 참고용 콘텐츠로, 리포트의 내용이나 관점에 대한 주관적 불만족은 환불 사유에 해당하지 않습니다.",
      "환불 요청 및 결제 관련 문의는 이메일(hansitoring@gmail.com)로 접수할 수 있으며, 회사는 접수일로부터 영업일 기준 3일 이내에 처리 결과를 안내합니다.",
    ],
  },
  {
    title: "제7조 (이용자의 의무)",
