...
const terms = [
  ...
  },
  {
    ...
    body: [
      "이용자는 유료 이용권 결제일로부터 7일 이내에, 결제한 분석 횟수를 전혀 사용하지 않은 경우 전액 환불을 요청할 수 있습니다.",
      "결제한 분석 횟수를 일부 사용한 경우, 결제 금액에서 사용한 횟수에 해당하는 금액(결제 금액을 총 제공 횟수로 나눈 금액 기준)을 차감한 잔액을 환불합니다.",
      "AI 분석 리포트는 제공 즉시 효용이 발생하는 디지털 콘텐츠로, 이미 제공이 완료된 분석 건에 대해서는 「전자상거래 등에서의 소비자보호에 관한 법률」 제17조 제2항에 따라 청약철회가 제한될 수 있습니다.",
