...
export function MentorCommentSection({ blocks, indexLabel = "07" }: { blocks: MentorCommentBlock[]; indexLabel?: string }) {
  return (
    <section id="section-pm-comment" className="pt-24 pb-20 section-divider report-section-anchor">
      <h3 className="text-xl sm:text-2xl font-medium text-white mb-10 tracking-tight"><SectionNumber value={indexLabel} />{UI_LABELS.PM_VERDICT_TITLE}</h3>
